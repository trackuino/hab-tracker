...
// TODO: if the service does not call any of this from a separate thread (which could be 
// accomplished by not performing updates from an AsyncTask in a service)
public class Prediction extends Observable {
	...
	public void reloadSoundingWinds(ContentResolver cr) {
		Cursor c = cr.query(Uri.withAppendedPath(
				PayloadContentProvider.CONTENT_URI, Database.Winds.name), null, null, null, null);
